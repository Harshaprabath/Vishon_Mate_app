...
from Services.BillServices.demo import test
...
def billValue(file: UploadFile, folder_name: str, filename: str) -> Response:
    ...
    if "slt" in text or "SLT" in text or "Telecom" in text or "Sri Lanka Telecom" in text or "Total payable" in text:
